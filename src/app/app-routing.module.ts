...
const routes: Routes = [
  {
    ...
    data: { pageTitle: "Home" },
    canActivateChild: [AuthComponent],
    children: [
      {
        path: "",
        redirectTo: "home",
      ...
      // },
       {
        ...
        {
            path: "doctors",
            loadChildren: "./features/doctors/doctors.module#DoctorsModule",
            data: { pageTitle: "Doctors" }
        }, {
            path: "hospitals",
            loadChildren: "./features/hospitals/hospitals.module#HospitalsModule",
